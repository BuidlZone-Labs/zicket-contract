...
//! are derived from Barretenberg `UltraZKFlavor` v0.87.0.
//!
...
pub const BATCHED_RELATION_PARTIAL_LENGTH: usize = 9;
...
pub struct Proof {
    ...
    pub libra_claimed_evaluation: Fr,
    pub libra_grand_sum_commitment: G1Point,
    pub libra_quotient_commitment: G1Point,
    pub hiding_polynomial_commitment: G1Point,
    pub hiding_polynomial_evaluation: Fr,
    ...
    pub libra_polynomial_evaluations: [Fr; 4],
    // Shplonk
